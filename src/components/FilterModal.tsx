...
import { Modal, List, Stack, Tooltip, Whisper, AutoComplete, SelectPicker, Message, useToaster } from 'rsuite'
                    ...
                    <Stack justifyContent="space-between" alignItems="center">
                      ...
                      <Stack spacing={6}>
                        ...
                        <Whisper placement="top" speaker={<Tooltip>Sil</Tooltip>}>
                          <button className="btn-icon btn-icon-delete" onClick={() => setPendingDelete(product)}>
                            <Trash2 size={18} />
                          </button>
                        </Whisper>
                      </Stack>
